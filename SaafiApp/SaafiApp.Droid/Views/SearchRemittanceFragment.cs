...
namespace SaafiApp.Droid.Views
{
    ...
    [Register("saafiapp.droid.views.SearchRemittanceFragment")]
    public class SearchRemittanceFragment : MvxFragment<SearchRemittanceViewModel>
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            (this.Activity as MainActivity).SetCustomTitle("Search Remittances");
        }
